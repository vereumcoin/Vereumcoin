...
void ThreadMapPort()
{
    ...
    if (r == 1)
    {
        ...
        string strDesc = "Vereum " + FormatFullVersion();
...
static const char *strMainNetDNSSeed[][2] = {
    {"159.65.42.88", "159.65.42.88"},
    {"159.65.160.80", "159.65.160.80"},
    {NULL, NULL}
};
...
bool BindListenPort(const CService &addrBind, string& strError)
{
    ...
    if (::bind(hListenSocket, (struct sockaddr*)&sockaddr, len) == SOCKET_ERROR)
    {
        ...
        if (nErr == WSAEADDRINUSE)
            strError = strprintf(_("Unable to bind to %s on this computer. Vereum is probably already running."), addrBind.ToString().c_str());
        else
